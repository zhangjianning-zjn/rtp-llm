...
class ModelRpcClient(object):
    ...
    async def enqueue(
        ...
        try:
            if input_pb.multimodal_inputs and not use_fetch_response:
                # Master-enqueued requests have already passed inspection while
                # preparing their embeddings. A second gate after admission can
                # abandon that work before FetchResponse attaches to it.
